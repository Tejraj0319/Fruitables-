    ...
    bestprodel.innerHTML += `
        <div class="col">
            <div class="card mb-3 p-4 rounded bg-light" style="max-width: 540px;">
              <div class="row g-0">
                <div class="col-md-6">
                  <img src=${prod.image} class="img-fluid rounded-circle mt-4" alt="...">
                </div>
                <div class="col-md-6">
                  <div class="card-body">
                    ...
                    <p class="card-text text-secondary">${prod.price}</p>
                    <button type="button" class="btn btn-outline-warning text-success rounded-pill" onclick=addtocart(${prod.id})>
                      <i class="fa-solid fa-bag-shopping me-2"></i> Add to cart
                    </button>
                  </div>
    ...
    bestprodel1.innerHTML += `
        <div class="col">
              <div class="card border border-0">
                <img src=${prod.image} class="card-img-top h-50 w-100 rounded" alt="...">
                <div class="card-body text-center">
                  <h4 class="card-title">${prod.name}</h4>
                  <p class="fs-5">
                  <i class="fa-solid fa-star" style="color: #81C408;"></i>
...
// cart array is created
let cart = JSON.parse(localStorage.getItem('cart')) || []
updatecart()
function addtocart(id) {
  // i.e     p.id==${prod.id}
  // ...p all keys of element
  if (cart.some((itm) => itm.id === id)) {
    ...
    console.log(cart)
    // stringify()  converts javascript object to stiring
    //setItem()  used to update value in cart(to convert into string)
...
// to show no of items added in cart
